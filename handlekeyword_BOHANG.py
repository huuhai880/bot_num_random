...
def chuyen_chuoi_sang_so(chuoi, number_skip):
    ...
    for _number_skip in lst_number_skip:
        ...
        filtered_numbers = [num for num in filtered_numbers if int(num) // 10 % 10 != int(_number_skip)]
...
async def handlekeyword_BOHANG (update: Update, context: ContextTypes.DEFAULT_TYPE):
    print("async def handlekeyword_BOHANG (update: Update, context: ContextTypes.DEFAULT_TYPE):")
